const employee = {
    template: `
<div>
    <button type="button" style="float: right;" class="btn btn-primary m-2 fload-end" data-bs-toggle="modal" data-bs-target="#exampleModal" @click="addClick()">Add Employee</button>
